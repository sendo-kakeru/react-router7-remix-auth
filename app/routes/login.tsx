...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  return {
    isMagicLinkSent: url.searchParams.get("state") === "magic-link-sent",
  };
}
...
export default function Login({ loaderData }: { loaderData: Awaited<ReturnType<typeof loader>> }) {
  ...
  return (
    <div className="">
      ...
      <Form action="/api/auth/google" method="post" className="mb-12">
        <button type="submit" className="gsi-material-button">
          ...
          <div className="gsi-material-button-content-wrapper">
            ...
            <span className="gsi-material-button-contents">Googleで続ける</span>
            <span style={{ display: "none" }}>Googleで続ける</span>
          </div>
        </button>
      </Form>
    </div>
