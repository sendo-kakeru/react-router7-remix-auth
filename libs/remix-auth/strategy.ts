import { type AppLoadContext, type SessionStorage, redirect } from "react-router";
 ...
 */
export type StrategyVerifyCallback<User, VerifyParams> = (params: VerifyParams) => Promise<User>;
...
export abstract class Strategy<User, VerifyOptions> {
  ...
  protected async failure(
    ...
    if (!options.failureRedirect) {
      ...
      throw Response.json({ message }, { status: 401 });
    }
